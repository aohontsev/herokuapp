...
var util = {
    attachEvent: function (element, eventname, handler) {
        ...
        var wrapper = function () {
            var event = window.event; // the event object is not writable
    ...
    ABC: [ [0xdf, 0xdf], [0x370, 0x6ff], [0x10a0, 0x10ff] ],
...
var json = {
    ...
    sendQuery: function (query) {
        ...
        script.onerror = function () {
            query.callback(null, { type: "HttpError", message: "Request failed", url: query.url });
            ref.disposeQuery(id);
        };
        query.timer = setTimeout(function () { json.timeout(id); }, json.TIMEOUT);
...
namespace.ya_ = { util: util, ajax: ajax, json: json };
