...
return}throw "Unable to print message: " + String(a)}}],["sunflower","file:///home/aohontsev/Projects/herokuapp/herokuapp/static/dart-projects/sunflower/web/sunflower.dart",,B,{
"^":"",
QL:[function(){var z=J.uX($.Aj())
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new B.em()),z.Sg),[H.Kp(z,0)]).Zz()
B.E2()},"call$0","HA",0,0,1],
E2:function(){var z,y,x,w,v,u
$.e9=H.Hp(J.Vm($.Aj()),null,null)
z=$.cM()
z.clearRect(0,0,300,300)
y=0
while(!0){x=$.e9
if(typeof x!=="number")return H.s(x)
if(!(y<x))break
...
z.fill()
z.closePath()
z.stroke();++y}$.oY().textContent=H.d(x)+" seeds"},
em:{
"^":"Tp:8;",
call$1:function(a){return B.E2()}}},1],])
...
init.metadata=[{func:"uO",args:[J.O]},{func:"X0",void:true},{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:J.kn},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner(function() { H.Rq(B.HA()); });
  } else {
    H.Rq(B.HA());
  }
})
